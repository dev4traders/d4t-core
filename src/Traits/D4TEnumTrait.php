...
/**
 * @implements \D4T\Core\D4TEnum;
 */
trait D4TEnumTrait
{
    protected static function ensureImplementsInterface(): void
    {
        throw_unless(class_implements(static::class, D4TEnum::class), new \Exception(sprintf('Enum %s must implement D4TEnum', static::class)));
    }
    ...
    {
        return $this instanceof D4TEnum ? $this->value : $this->name;
    }
    ...
    public static function __callStatic($name, $args)
    {
        ...
        foreach ($cases as $case) {
            if ($case->name === $name) {
                return $case instanceof D4TEnum ? $case->value : $case->name;
            }
        }
